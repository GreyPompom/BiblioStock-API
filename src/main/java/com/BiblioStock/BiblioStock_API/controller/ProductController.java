...
public class ProductController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Lista retornada com sucesso", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ProductResponseDTO.class))),
    ...
    public ResponseEntity<ProductResponseDTO> create(
            @Parameter(description = "DTO com os dados do produto", required = true) @Valid @RequestBody ProductRequestDTO dto) {
    ...
    public ResponseEntity<ProductResponseDTO> update(
            @Parameter(description = "ID do produto", required = true) @PathVariable Long id,
            @Parameter(description = "DTO com os dados atualizados", required = true) @Valid @RequestBody ProductRequestDTO dto) {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Lista de produtos retornada com sucesso", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ProductResponseDTO.class))),
